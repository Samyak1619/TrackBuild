...
// Query to fetch construction details for the admin
$constructions = [];
$construction_query = "SELECT * FROM constructions WHERE user_id = ?";
    ...
    <div class="main-content">
        ...
        <div class="projects-section">
            ...
            <?php if (!empty($constructions)): ?>
                <a href="admindetailspage.php?id=<?php echo $constructions[0]['id']; ?>" style="text-decoration: none; color: inherit;">
                    <div class="current-project">
                        <h2>Current Project 🏗️</h2>
                        <p><strong>Project Name:</strong> <?php echo $constructions[0]['construction_name']; ?></p>
                        <p><strong>Status:</strong>  initial stage</p> <!-- Update status dynamically if needed -->
                        <p><strong>Deadline:</strong> <?php echo $constructions[0]['expected_completion_date']; ?></p>
                    </div>
                </a>
            <?php else: ?>
                <div class="current-project">
                    <h2>No Active Projects 🏗️</h2>
            ...
            <div class="project-list">
                ...
                <?php if (!empty($constructions)): ?>
                    <?php foreach ($constructions as $construction): ?>
                        <a href="admindetailspage.php?id=<?php echo $construction['id']; ?>" style="text-decoration: none; color: inherit;">
                            <div class="project-item">
                                <img src="images/construction.png" alt="Project Icon">
                                <p><?php echo $construction['construction_name']; ?></p>
                            </div>
                        </a>
                    <?php endforeach; ?>
                <?php else: ?>
            ...
            <?php if (!empty($constructions)): ?>
                <?php foreach ($constructions as $construction): ?>
                    <div class="report-item">
                        <h3><?php echo $construction['construction_name']; ?> - Weekly Report</h3>
                        <p>Progress: initial stage</p> <!-- Add real progress data if available -->
                        <p>Key updates: <?php echo $construction['description']; ?></p>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
                <p>No reports available. Add a new project to generate reports.</p>
            <?php endif; ?>
        </div>
    </div>
</div>
